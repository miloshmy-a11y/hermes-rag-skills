...
PYTHONPATH="/c/Users/<USER>/AppData/Roaming/Python/Python314/site-packages" python3 your_script.py
```
...
path = r'C:\Users\<USER>\AppData\Roaming\Python\Python314\site-packages'

# BAD - Causes UnicodeDecodeError
path = '<HERMES_HOME>\\AppData\Roaming\\...'  # Broken backslashes

# GOOD - Use forward slashes (bash compatible)
path = '/c/Users/<USER>/AppData/Roaming/Python/Python314/site-packages'
```
